# CivicProof Presentation & Demo Script
**Theme:** "Community Hero — Hyperlocal Problem Solver"

---

## 1. The Hook (The Introduction)
* **Visual:** Primary Dashboard displaying active neighborhood cases, public Harm Scores, and Silence Clock countdowns.
* **Speaker:**
> *"Citizens do not need another form. They need a way to turn local frustration into credible public proof. Traditional municipal portals fail because they treat every submission as an isolated complaint. Municipalities get overwhelmed, duplicates get filed, and tickets languish in bureaucratic silence."*

---

## 2. Core Narrative (The Problem & Thesis)
* **Visual:** Hover over an active case on the map.
* **Speaker:**
> *"We do not collect complaints. We build civic case files. CivicProof is an evidence-backed civic case engine that turns posts into proof, duplicates into verification, and complaints into cases."*
...
* **Visual:** System flashes: *"Nearby duplicate case detected on this block!"*
* **Speaker:**
...
## 4. Closing Statement
* **Speaker:**
> *"CivicProof turns posts into proof, duplicates into verification, and complaints into cases. This is how we rebuild municipal accountability—one neighborhood block at a time. Thank you."*
